...
public class IFTextView extends AppCompatTextView {
    ...
    public IFTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        applyFont(context);
    }

    public IFTextView(Context context, AttributeSet attrs, int defStyle) {
